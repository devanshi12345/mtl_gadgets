               ...
               <div id="productMain" class="row"><!-- row Begin -->
                   ...
                   <div class="col-sm-6"><!-- col-sm-6 Begin -->
                       ...
                       <div class="row" id="thumbs"><!-- row Begin -->
                           ...
                           <div class="col-xs-4"><!-- col-xs-4 Begin -->
                               <adata-target="#myCarousel" data-slide-to="1" href="#" class="thumb"><!-- thumb Begin -->
                                   <img src="admin_area/product_images/<?php echo $pro_img2; ?>" alt="product 2" class="img-responsive">
                               </a><!-- thumb Finish -->
                           </div><!-- col-xs-4 Finish -->
                           
                           <div class="col-xs-4"><!-- col-xs-4 Begin -->
                               <adata-target="#myCarousel" data-slide-to="2" href="#" class="thumb"><!-- thumb Begin -->
                        ...
                        <div class='col-md-3 col-sm-6 center-responsive'>
                            ...
                            <div class='product same-height'>
                                ...
                                <a href='details.php?pro_id=$pro_id'>
                                    ...
                                    <img class='img-responsive' src='admin_area/product_images/$pro_img2'>
